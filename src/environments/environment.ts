...
export const environment = {
  ...
  warningDialog: {
    title: 'Warning',
    content: 'This system is for AUTHORISED USE ONLY. Unauthorized access will result in possible legal action. By accessing this system, you acknowledge that you are authorized to do so and that all data stored and processed here is confidential.',
    buttonText: 'Close'
  },
